...
class ProcumentStyleVariant {
  ...
  factory ProcumentStyleVariant.fromJson(
    ...
    return ProcumentStyleVariant(
      ...
      variantName: json["Variant Name"] ?? json['Varient Name'] ??'',
      style: json["Style"] ?? '',
      oldVariant: json["Old Variant"] ?? json["Old Varient"] ??'',
      customerVariant: json["Customer Variant"] ?? json["Customer Varient"] ??'',
      baseVariant: json["Base Variant"] ?? json["Base Varient"] ?? '',
      vendor: json["Vendor"] ?? '',
      remark1: json["Remark 1"] ?? '',
      vendorVariant: json["Vendor Variant"] ??json["Vendor Varient"] ?? '',
