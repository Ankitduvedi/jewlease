...
class RmInventoryStatNotifier extends StateNotifier<Map<String, String>> {
  RmInventoryStatNotifier()
      : super({
    "TotalRows": "0",
    "Pcs": "0",
    "Wt": "0",
...
final RmInventorySummaryProvider =
StateNotifierProvider<RmInventoryStatNotifier, Map<String, String>>((ref) {
  return RmInventoryStatNotifier();
});
