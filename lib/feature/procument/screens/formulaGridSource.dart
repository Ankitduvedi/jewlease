...
class formulaGridSource extends DataGridSource {
  ...
  double calculateFormulaVaule(int index, double cellValue) {
    ...
    String formula = formulaExcel[index].rowExpression;
  ...
  void recalculatedataGridValues(int updatedRowIndex, double cellNewValue) {
    print(
    ...
    for (int i = 0; i < dataGridRows.length; i++) {
      ...
      if (i == 2) {
        String? rangeHierarchyName = formulaExcel[i].rowExpressionValue;
        print(
