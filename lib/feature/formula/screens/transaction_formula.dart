...
import '../../procument/screens/formulaGridSource.dart';
import '../../vendor/controller/procumentVendor_controller.dart';

class TransactionFormulaDataGrid extends ConsumerStatefulWidget {
  const TransactionFormulaDataGrid(this.varientName, this.varientIndex,
      {super.key});
...
class FormulaDataGridState extends ConsumerState<TransactionFormulaDataGrid> {
                            ...
                            label: Container(
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.only(
                                      topLeft: formulaGridHeaders.indexOf(
                                          columnName) == 0 ? Radius.circular(
                                          10): Radius.zero,
                                      topRight: formulaGridHeaders.indexOf(
                                          columnName) == formulaGridHeaders.length-1 ? Radius.circular(
                                          10): Radius.zero,
                                  )),
