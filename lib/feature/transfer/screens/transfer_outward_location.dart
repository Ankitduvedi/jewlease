...
import 'package:jewlease/feature/transfer/controller/outward_loc_controller.dart';
...
class _TransferoutwardLocLocationState
  ...
  final DataGridController outwardLocDataGridController = DataGridController();
  List<DataGridRow> outwardLocRows = [];
  ...
  void initState() {
    ...
    _procumentdataGridSource =
        ProcumentDataGridSource(outwardLocRows, (DataGridRow) {}, () {}, false);
    Future.delayed(
      Duration(milliseconds: 500),
      () => showDialog(
        context: context,
        builder: (context) => const Dialog(
          child: TransferOutwardLocationDialog(),
        ),
      ),
    );
    super.initState();
    ...
    setState(() {
      outwardLocRows.add(
        DataGridRow(cells: [
          ...
          DataGridCell(columnName: "Item Stryle", value: varient["Item Group"]),
  ...
  void _otwardSummery(Map<String, dynamic> updatedVarient) {
    ...
    try {
      ...
      outwardLocRows.forEach((element) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                child: Container(
                  ...
                  child: Theme(
                    ...
                    child: SfDataGrid(
                      ...
                      controller: outwardLocDataGridController,
                      footerFrozenColumnsCount: 1,
                      // Freeze the last column
                      columns: transferoutwardLocColumnns.map((columnName) {
                        return GridColumn(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.only(
                                topRight: Radius.circular(
                                    transferoutwardLocColumnns
                                                .indexOf(columnName) ==
                                            transferoutwardLocColumnns.length -
                                                1
                                        ? 15
                                        : 0),
      ...
      floatingActionButton: outwardLocRows.length == 0
          ? Container()
          : SummaryDetails(
