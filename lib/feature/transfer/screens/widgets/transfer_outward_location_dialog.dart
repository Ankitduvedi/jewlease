...
class TransferOutwardLocationDialog extends ConsumerStatefulWidget {
  const TransferOutwardLocationDialog({super.key});

  @override
  ConsumerState<TransferOutwardLocationDialog> createState() =>
      _TransferOutwardLocationDialogState();
}

class _TransferOutwardLocationDialogState
    extends ConsumerState<TransferOutwardLocationDialog> {
