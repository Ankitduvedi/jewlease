...
class AddSetItemScreen extends ConsumerStatefulWidget {
  const AddSetItemScreen({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    return AddSetItemScreenScreenState();
  }
}

class AddSetItemScreenScreenState extends ConsumerState<AddSetItemScreen> {
