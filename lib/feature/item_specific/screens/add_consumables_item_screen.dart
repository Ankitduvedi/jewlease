...
class AddConsumablesItemScreen extends ConsumerStatefulWidget {
  const AddConsumablesItemScreen({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    return AddConsumablesItemScreenState();
  }
}

class AddConsumablesItemScreenState
    extends ConsumerState<AddConsumablesItemScreen> {
